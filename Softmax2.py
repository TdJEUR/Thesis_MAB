...
fig1.legend((r"$T=$" + str(temperature[0]), r"$T=$" + str(temperature[1]), r"$T=$" + str(temperature[2]),
             r"$T=$" + str(temperature[3])))
fig2.title.set_text(r'Softmax : $\%$ Optimal Action Vs Steps for 10 arms')
fig2.set_ylabel(r'$\%$ Optimal Action')
fig2.set_xlabel('Steps')
fig2.set_ylim(0, 100)
fig2.legend((r"$T=$" + str(temperature[0]), r"$T=$" + str(temperature[1]), r"$T=$" + str(temperature[2]),
             r"$T=$" + str(temperature[3])))
plt.show()
