...
from Helpers import generate_combinations, calculate_diversity, generate_MAB_Matrix
import pandas as pd
...
for mab in range(num_mabs):
    ...
    # Create lists containing results
    MAB_acc_rewards_cp = []
    MAB_acc_rewards_b = []
...
# Save results
merged_df.to_excel(f'C:/Users/tommo/Downloads/Thesis_MAB/Data/Merged_{num_mabs}mabs_{num_sims}sims_10arms.xlsx', index=False, engine='openpyxl')
df_B_final.to_excel(f'C:/Users/tommo/Downloads/Thesis_MAB/Data/df_B_{num_mabs}mabs_{num_sims}sims_10arms.xlsx', index=False, engine='openpyxl')
df_CP_final.to_excel(f'C:/Users/tommo/Downloads/Thesis_MAB/Data/df_CP_{num_mabs}mabs_{num_sims}sims_10arms.xlsx', index=False, engine='openpyxl')
